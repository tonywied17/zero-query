 ...
 * Entry: cli\scaffold\scripts\components\about.js
 * 2026-03-06T00:32:55.270Z
 */
(function() {
  'use strict';
...
function computed(fn) { const s = new Signal(undefined); effect(() => { s._value = fn(); s._notify(); }); return s;0.4.6
}
